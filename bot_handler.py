...
# Imports from our "New Named" files but treating them as modules
from gmail_client import get_latest_message_id, get_latest_email_details, send_email, get_credentials
from auth_manager import run_flask_server, get_login_link
from ai_engine import summarize_email, generate_draft_reply
...
async def check_new_emails_job(context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if latest_id and latest_id != last_checked_email_id:
            last_checked_email_id = latest_id
            details = get_latest_email_details()
