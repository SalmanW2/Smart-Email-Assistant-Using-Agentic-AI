...
class AI_Engine:
    ...
    def general_chat(self, text):
        ...
        try:
            ...
            return self.client.models.generate_content(model=self.model_name, contents=prompt).text
        except Exception: return "I encountered an error processing your request. Please use the menu to navigate."
    ...
    def guest_chat(self, text):
        ...
        try:
            ...
            return self.client.models.generate_content(model=self.model_name, contents=prompt).text
        except Exception: return "Main abhi development phase mein hu aur sirf apne owner ko serve kar raha hu. Baad mein try karein!"
